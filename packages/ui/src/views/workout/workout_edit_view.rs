use crate::{
    components::workout::workout_edit_form::WorkoutEditForm, hooks::workout::use_workout_resource,
    views::Loading,
};
use dioxus::prelude::*;
use fgdb::data::workout::WorkoutShowParams;

#[component]
pub fn WorkoutEditView(workout_id: usize) -> Element {
    let params_sig = use_signal(|| WorkoutShowParams {
