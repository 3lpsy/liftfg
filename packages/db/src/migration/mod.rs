...
pub mod m20250115_110424_create_program;
pub mod m20250115_173443_create_program_muscle;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20250115_110424_create_program::Migration),
            Box::new(m20250115_173443_create_program_muscle::Migration),
